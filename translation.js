...
$(function () {
  ...
  const supportedLanugages = ['cn', 'ja', 'en', 'vn', 'pt-br', 'pt-pt', 'es', 'ko', 'de', 'tr', 'ara', 'it', ];
  ...
  if (code === 'cn') {
	...
	dict = {
	  ...
	  publicMetrics:          "Genel Metrikler",
	  awards:                 "ÖDÜLLER",
	  news:                   "Cardano Haberleri",
	  subscribe:              "Havuz güncellemelerini almak için kaydolun",
	  phone:                  "Telefon",
	  name:                   "İsim",
	  firstName:              "İlk adı",
	  lastName:               "Soyadı",
	  ...
	  emailSubject:           "Ders",
	  emailBody:              "İleti",
	  countryCodeDescription: "Ülke kodu dahil telefon numarası",
	  howToBuy:               "NASIL ALINIR",
	  buyOn:                  "Şuradan satın alabilirsiniz: ",
	  submit:                 "Göndermek",
	  signUp:                 "Üye olmak",
	  contactUsDescription:   "Herhangi bir sorunuz veya yorumunuz varsa, lütfen e-posta veya telefon yoluyla bizimle iletişime geçin veya iletişim formunu kullanarak bize bir mesaj gönderin.",
	  relays:                 "RÖLELER",
	  ends:                   "içinde biter",
	  price:                  "Fiyat",
	  howToStake:             "NASIL PAY YAPILIR",
	  stakeOn:                "Şunlardan bahis yapabilirsiniz: ",
	  ticker:                 "hisse senedi",
	  poolId:                 "havuz kimliği",
	  epoch:                  "çağ",
	  epochTip:               "Cardano ağı, zamanı dönem adı verilen dönemlere böler. Bir dönem yaklaşık 5 gün sürer.",
	  pledge:                 "Rehin",
	  pledgeTip:              "Pay havuzu sahibinin havuza devretmeyi taahhüt ettiği miktar.",
	  totalStake:             "Toplam Bahis",
	  totalStakeTip:          "Gerçek zamanlı olarak devredilen toplam tutar.",
	  delegators:             "Yetkilendirenler",
	  delegatorsTip:          "Havuza devredilen cüzdan sayısı.",
	  margin:                 "marj",
	  marginTip:              "Sabit maliyetten sonra bahis havuzu operatörü tarafından alınan havuzun toplam ödüllerinin yüzdesi.",
	  fixedCost:              "Sabit ücret",
	  fixedCostTip:           "Havuzun sabit maliyeti, her dönem havuz ödüllerinden alınır. Bu ücret, delege başına değil, havuzun tüm delegeleri arasında paylaşılır. Minimum değer 340 ADA'dır.",
	  lifetimeROA:            "Ömür boyu ROA",
	  lifetimeROATip:         "ADA'nın Tahmini Getirisi, ömür boyu stake ödüllerine dayalı olarak yıllıklandırılmıştır. Sahip/lider ödülleri hesaplamanın dışında tutulur.",
	  epochBlocks:            "Dönem Blokları",
	  epochBlocksTip:         "Gerçek çağda basılan blokların sayısı.",
	  lifetimeBlocks:         "Ömür Boyu Bloklar",
	  lifetimeBlocksTip:      "Ömür boyu basılan blokların sayısı.",
	  lifetimeLuck:           "ömür boyu şans",
	  lifetimeLuckTip:        "Havuzun üretmesi beklenen miktara karşı kaç blok üretildiğinin bir ölçüsü. Uzun vadede, şans ortalama %100'e çıkar.",
	  supporter:              "ADApools.org Seviye 3 Destekçisi",
	  formSubmission:         "Teşekkürler! Size bir onay e-postası gönderildi.",
	  relaysTip:              "Röle düğümleri, çekirdek ağ düğümleri ile internet arasında vekiller olarak hareket ederek çekirdek, blok üreten ağ düğümleri etrafında bir güvenlik çevresi oluşturur. Röleler, bir veya daha fazla röle tehlikeye girse bile, çekirdek düğümlerin ve blok zincirinin bütünlüğünün bozulmadan kalmasını sağlar.",
	  howToStakeTip:          "Stake için kullanılan ADA, delegasyonun cüzdanından asla çıkmaz ve yetki verenler, bir tasarruf hesabındaki faize benzer bir şekilde ödüller kazanır. Yetki verenler, ADA'larını stake edildikten sonra serbestçe hareket ettirebilir veya hatta isterlerse tamamen kaldırabilir.",
	  poolDescription:        "Havuzumuz yeni ve büyümesi için yardımınıza ihtiyacı var. Hiçbir bloğu kaçırmamaya kararlıyız. Sıfır marj, çok katmanlı güvenlik, 7/24 izleme, yüksek performanslı düğümler ve coğrafi olarak yedekli bağlantılarla ödüllerinizi en üst düzeye çıkarın.",
	  priceTip:               "Cardano ADA Fiyatı",
	  endsDay:                "günler",
	  endsHour:               "saatler",
	  endsMinute:             "dakika",
	  currencySymbol:         "₺",
	  pricePair:              "ADA-TRY",
	  cointelegraph:          "https://tr.cointelegraph.com/search?query=cardano",
	  coinbase:               "https://www.coinbase.com/tr",
	  kraken:                 "https://www.kraken.com/tr-tr/",
	};
  } else if (code === 'de') {
	dict = {
	  contactUs:              "Neem contact met ons op",
	  publicMetrics:          "Openbare statistieken",
	  awards:                 "PRIJZEN",
	  news:                   "Cardano Nieuws",
	  subscribe:              "Meld u aan om zwembadupdates te ontvangen",
	  phone:                  "Telefoon",
	  name:                   "Naam",
	  firstName:              "Voornaam",
	  lastName:               "Achternaam",
	  ...
	  emailBody:              "Bericht",
	  countryCodeDescription: "Telefoonnummer inclusief landcode",
	  howToBuy:               "HOE TE KOPEN",
	  buyOn:                  "U kunt kopen op: ",
	  submit:                 "Indienen",
	  signUp:                 "Inschrijven",
	  contactUsDescription:   "Heeft u vragen of opmerkingen, neem dan contact met ons op via e-mail of telefoon, of stuur ons een bericht via het contactformulier.",
	  relays:                 "RELAIS",
	  ends:                   "Eindigt in",
	  price:                  "Prijs",
	  howToStake:             "HOE IN TE NEMEN?",
	  stakeOn:                "U kunt inzetten via: ",
	  ticker:                 "ticker",
	  poolId:                 "Zwembad-ID",
	  epoch:                  "Tijdperk",
	  epochTip:               "Cardano-netwerk verdeelt tijd in perioden die tijdperken worden genoemd. Een tijdperk duurt ongeveer 5 dagen.",
	  pledge:                 "Belofte",
	  pledgeTip:              "Het bedrag dat de eigenaar van de ringpool toezegt aan de pool te delegeren.",
	  totalStake:             "Totale inzet",
	  totalStakeTip:          "Het totale bedrag dat in realtime wordt gedelegeerd.",
	  delegators:             "afgevaardigden",
	  delegatorsTip:          "Het aantal portefeuilles dat naar de pool wordt gedelegeerd.",
	  margin:                 "Marge",
	  marginTip:              "Een percentage van de totale beloningen van de pool die door de exploitant van de pool van de inzet worden genomen na de vaste kosten.",
	  fixedCost:              "Vaste kosten",
	  fixedCostTip:           "De vaste kosten van de pool worden elk tijdperk van de poolbeloningen afgetrokken. Deze vergoeding wordt verdeeld over alle deelnemers van de pool, niet per deelnemer. Minimale waarde is 340 ADA.",
	  lifetimeROA:            "Levenslange ROA",
	  lifetimeROATip:         "Geschatte opbrengst van ADA, op jaarbasis gebaseerd op levenslange inzetbeloningen. Beloningen voor eigenaren/leiders worden niet meegerekend.",
	  epochBlocks:            "Epoch-blokken",
	  epochBlocksTip:         "Het aantal geslagen blokken in het werkelijke tijdperk.",
	  lifetimeBlocks:         "Levenslange blokken",
	  lifetimeBlocksTip:      "Het aantal geslagen blokken levensduur.",
	  lifetimeLuck:           "levenslang geluk",
	  lifetimeLuckTip:        "Een maatstaf voor hoeveel blokken er zijn geproduceerd versus de hoeveelheid die de pool naar verwachting zal produceren. Op de lange termijn komt het geluk gemiddeld uit op 100%.",
	  supporter:              "ADApools.org Niveau 3 Supporter",
	  formSubmission:         "Dank u! Er is een bevestigingsmail naar u verzonden.",
	  relaysTip:              "Relay-knooppunten fungeren als proxy's tussen de kernnetwerkknooppunten en internet, waardoor een beveiligingsperimeter rond de kern wordt gevormd, blokproducerende netwerkknooppunten. Relais zorgen ervoor dat de integriteit van de core nodes en de blockchain intact blijft, ook als een of meerdere relais in gevaar komen.",
	  howToStakeTip:          "De ADA die wordt gebruikt voor staking verlaat nooit de portemonnee van de delegator en delegators verdienen beloningen op een manier die vergelijkbaar is met rente op een spaarrekening. Delegators kunnen hun ADA vrij bewegen nadat het is ingezet of zelfs volledig uitzetten als ze dat willen.",
	  poolDescription:        "Ons zwembad is nieuw en heeft jouw hulp nodig om te groeien. We zijn toegewijd om nooit een blok te missen. Maximaliseer uw beloningen met nulmarge, meerlaagse beveiliging, 24/7 monitoring, hoogwaardige nodes en geografisch redundante verbindingen.",
	  priceTip:               "Cardano ADA prijs",
	  endsDay:                "dagen",
	  endsHour:               "uur",
	  endsMinute:             "minuten",
	  currencySymbol:         "€",
	  pricePair:              "ADA-EUR",
	  coinQuora:              "https://coinquora.com/de/?s=cardano",
	  cointelegraph:          "https://de.cointelegraph.com/search?query=cardano",
	  coinbase:               "https://www.coinbase.com/de",
	};
  } else if (code === 'it') {
	dict = {
	  contactUs:              "Contattaci",
	  publicMetrics:          "Metriche pubbliche",
	  awards:                 "PREMI",
	  news:                   "Novità Cardano",
	  subscribe:              "Iscriviti per ricevere gli aggiornamenti della piscina",
	  phone:                  "Telefono",
	  name:                   "Nome",
	  ...
	  emailSubject:           "Materia",
	  emailBody:              "Messaggio",
	  countryCodeDescription: "Numero di telefono incluso il prefisso internazionale",
	  howToBuy:               "COME COMPRARE",
	  buyOn:                  "Puoi acquistare su: ",
	  submit:                 "Invia",
	  signUp:                 "Iscriviti",
	  contactUsDescription:   "Se hai domande o commenti, ti preghiamo di contattarci via e-mail o telefono o inviarci un messaggio utilizzando il modulo di contatto.",
	  relays:                 "RELÈ",
	  ends:                   "Finisce in",
	  price:                  "Prezzo",
	  howToStake:             "COME PUNTARE",
	  stakeOn:                "Puoi puntare tramite: ",
	  ticker:                 "Ticker",
	  poolId:                 "ID piscina",
	  epoch:                  "Epoca",
	  epochTip:               "La rete Cardano divide il tempo in periodi chiamati epoche. Un'epoca dura circa 5 giorni.",
	  pledge:                 "Impegno",
	  pledgeTip:              "L'importo che il proprietario del pool di palo si impegna a delegare al pool.",
	  totalStake:             "Puntata totale",
	  totalStakeTip:          "L'importo totale che viene delegato in tempo reale.",
	  delegators:             "Deleganti",
	  delegatorsTip:          "Il numero di portafogli che delegano al pool.",
	  margin:                 "Margine",
	  marginTip:              "Una percentuale dei premi totali del pool prelevati dall'operatore del pool di puntate dopo il costo fisso.",
	  fixedCost:              "Costo fisso",
	  fixedCostTip:           "Il costo fisso del pool è preso dai premi del pool ogni epoca. Questa commissione è condivisa tra tutti i deleganti del pool, non per delegante. Il valore minimo è 340 ADA.",
	  lifetimeROA:            "ROA a vita",
	  lifetimeROATip:         "Rendimento stimato di ADA, annualizzato in base ai premi di puntata a vita. I premi proprietario/leader sono esclusi dal calcolo.",
	  epochBlocks:            "Blocchi Epoca",
	  epochBlocksTip:         "Il numero di blocchi coniati nell'epoca attuale.",
	  lifetimeBlocks:         "Blocchi a vita",
	  lifetimeBlocksTip:      "Il numero di blocchi coniati durante la vita.",
	  lifetimeLuck:           "Fortuna a vita",
	  lifetimeLuckTip:        "Una misura del numero di blocchi che sono stati prodotti rispetto alla quantità che dovrebbe produrre il pool. A lungo termine, la fortuna è in media del 100%.",
	  supporter:              "Sostenitore di livello 3 di ADApools.org",
	  formSubmission:         "Grazie! Una email di conferma è stata inviata a voi.",
	  relaysTip:              "I nodi di inoltro fungono da proxy tra i nodi della rete principale e Internet, stabilendo un perimetro di sicurezza attorno ai nodi di rete principali e che producono blocchi. I relè assicurano che l'integrità dei nodi principali e della blockchain rimanga intatta, anche se uno o più relè vengono compromessi.",
	  howToStakeTip:          "L'ADA utilizzato per lo staking non lascia mai il portafoglio del delegante e i deleganti guadagnano ricompense in un modo simile all'interesse in un conto di risparmio. I deleganti possono spostare liberamente il loro ADA dopo che è stato picchettato o addirittura annullarlo completamente se lo desiderano.",
	  poolDescription:        "La nostra piscina è nuova e ha bisogno del tuo aiuto per crescere. Ci impegniamo a non perdere mai un blocco. Massimizza i tuoi premi con margine zero, sicurezza multilivello, monitoraggio 24 ore su 24, 7 giorni su 7, nodi ad alte prestazioni e connessioni geo-ridondanti.",
	  priceTip:               "Cardano ADA Prezzo",
	  endsDay:                "giorni",
	  endsHour:               "ore",
	  endsMinute:             "minuti",
	  currencySymbol:         "€",
	  pricePair:              "ADA-EUR",
	  cointelegraph:          "https://it.cointelegraph.com/search?query=cardano",
	  coinbase:               "https://www.coinbase.com/it",
	  kraken:                 "https://www.kraken.com/it-it/",
	};
  } else if (code === 'ara') {
	dict = {
	  contactUs:              "اتصل بنا",
	  publicMetrics:          "المقاييس العامة",
	  awards:                 "الجوائز",
	  news:                   "أخبار كاردانو",
	  subscribe:              "قم بالتسجيل لتلقي تحديثات المجمع",
	  phone:                  "هاتف",
	  name:                   "اسم",
	  ...
	  emailSubject:           "موضوع",
	  emailBody:              "رسالة",
	  countryCodeDescription: "رقم الهاتف متضمنًا رمز الدولة",
	  howToBuy:               "كيف اشترى",
	  buyOn:                  "يمكنك الشراء على: ",
	  submit:                 "إرسال",
	  signUp:                 "اشتراك",
	  contactUsDescription:   "إذا كان لديك أي أسئلة أو تعليقات ، يرجى الاتصال بنا عبر البريد الإلكتروني أو الهاتف ، أو إرسال رسالة إلينا باستخدام نموذج الاتصال.",
	  relays:                 "يمرر",
	  ends:                   "ينتهي بـ",
	  price:                  "السعر",
	  howToStake:             "كيفية الرهان",
	  stakeOn:                "يمكنك الرهان من خلال: ",
	  ticker:                 "شريط",
	  poolId:                 "معرف التجمع",
	  epoch:                  "عصر",
	  epochTip:               "تقسم شبكة كاردانو الوقت إلى فترات تسمى العصور. حقبة واحدة تستمر حوالي 5 أيام.",
	  pledge:                 "يتعهد",
	  pledgeTip:              "المبلغ الذي يلتزم به مالك تجمع الأسهم لتفويضه إلى التجمع.",
	  totalStake:             "إجمالي الرهان",
	  totalStakeTip:          "المبلغ الإجمالي الذي يتم تفويضه في الوقت الفعلي.",
	  delegators:             "المندوبين",
	  delegatorsTip:          "عدد محافظ التفويض للمجمع.",
	  margin:                 "هامش",
	  marginTip:              "نسبة مئوية من إجمالي مكافآت المجمع التي حصل عليها مشغل تجمع الأسهم بعد التكلفة الثابتة.",
	  fixedCost:              "تكلفة ثابتة",
	  fixedCostTip:           "يتم أخذ التكلفة الثابتة للمجمع من مكافآت البلياردو في كل فترة. يتم تقاسم هذه الرسوم بين جميع المفوضين في التجمع ، وليس لكل مفوض. الحد الأدنى للقيمة هو 340 ADA.",
	  lifetimeROA:            "العائد على الأصول لمدى الحياة",
	  lifetimeROATip:         "العائد التقديري لـ ADA ، سنويًا بناءً على مكافآت Staking مدى الحياة. يتم استبعاد مكافآت المالك / القائد من الحساب.",
	  epochBlocks:            "كتل العصر",
	  epochBlocksTip:         "عدد الكتل المسكوكة في العصر الفعلي.",
	  lifetimeBlocks:         "كتل العمر",
	  lifetimeBlocksTip:      "عدد القطع العمرية المسكوكة.",
	  lifetimeLuck:           "مدى الحياة",
	  lifetimeLuckTip:        "مقياس لعدد الكتل التي تم إنتاجها مقابل الكمية التي من المتوقع أن ينتجها المجمع. على المدى الطويل ، يصل متوسط ​​الحظ إلى 100٪.",
	  supporter:              "ADApools.org مؤيد المستوى 3",
	  formSubmission:         "شكرا لك! تم إرسال رسالة تأكيد إليك.",
	  relaysTip:              "تعمل عُقد الترحيل كوكلاء وكلاء بين عقد الشبكة الأساسية والإنترنت ، مما يؤدي إلى إنشاء محيط أمني حول العقد الأساسية للشبكة المنتجة للكتل. تضمن المرحلات بقاء سلامة العقد الأساسية و blockchain سليمة ، حتى إذا تم اختراق واحد أو أكثر من المرحلات.",
	  howToStakeTip:          "لا يترك ADA المستخدم للتخزين أبدًا محفظة المفوض ، ويكسب المندوبون مكافآت بطريقة تشبه الفائدة في حساب التوفير. يمكن للمفوضين نقل ADA الخاص بهم بحرية بعد أن يتم تجميده أو حتى فكه تمامًا إذا اختاروا ذلك.",
	  poolDescription:        "حمام السباحة الخاص بنا جديد ويحتاج إلى مساعدتك لينمو. نحن ملتزمون بعدم فقدان أي كتلة. قم بزيادة مكافآتك إلى الحد الأقصى من خلال هامش صفري ، وأمان متعدد الطبقات ، ومراقبة على مدار الساعة طوال أيام الأسبوع ، وعقد عالية الأداء ، واتصالات زائدة عن الحاجة جغرافيًا.",
	  priceTip:               "سعر كاردانو ADA",
	  endsDay:                "أيام",
	  endsHour:               "ساعات",
	  endsMinute:             "الدقائق",
	  currencySymbol:         "د.إ",
	  pricePair:              "ADA-AED",
	  cointelegraph:          "https://ar.cointelegraph.com/search?query=%D9%83%D8%A7%D8%B1%D8%AF%D8%A7%D9%86%D9%88",
	};
  }
